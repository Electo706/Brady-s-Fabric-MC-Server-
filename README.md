...
4. Mods Installed in /.minecraft/mods:
  5. Fabric API                                           (https://modrinth.com/mod/fabric-api/version/0.146.1+26.1.2)
  6. Common-Networking                                    (https://modrinth.com/mod/common-network/version/1.0.22-26.1.2)
7. (Optional but highly recommended) Sodium Installed     (https://modrinth.com/mod/sodium/version/mc26.1.1-0.8.9-fabric)
8. (Optional) Iris Installed                              (https://modrinth.com/mod/iris/version/1.10.9+26.1-fabric)
